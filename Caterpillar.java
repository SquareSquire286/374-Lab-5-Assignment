public class Caterpillar extends Grass
{
    public Caterpillar()
    {
	identifyingChar = 'C';
	foodChainIndex = 1; // the 1st level implies that an organism feeds on grass and shrubbery (known as a primary consumer)
	isCarnivorous = false;
	numberOfLimbs = 0;
    }
	...
	System.out.println("The caterpillar can be found at (" + xPosGenerator + " , " + yPosGenerator + ").");
    }
}
